    ...
    \subsection{The Discrete GSA}
        ...
        \subsubsection{The Geometry of Tour Space}
            ...
            \begin{algorithm}
                ...
                \KwOut{int distance}
                $y^\prime \gets y$\;
                \For{i = each index of x}{
                    $index \gets$ position of $x[i]$ in $y^\prime$\;
                    swap elements at indices $i$ and $index$ of $y^\prime$\;
                    \If{$y^\prime == x$}{
                        \Return{$i$}
                    }
                }
