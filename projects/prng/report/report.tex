...
\begin{enumerate}
\item Ackley's One:
    \begin{equation} \label{eq:ackley_one}
    \begin{aligned}
...
\item Ackley's Two:
    \begin{equation} \label{eq:ackley_two}
    \begin{aligned}
...
\item 1st De Jong's:
    \begin{equation} \label{eq:de_jong}
    \begin{aligned}
...
\item Griewangk:
    \begin{equation} \label{eq:griewangk}
    \begin{aligned}
